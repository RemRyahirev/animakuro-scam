...
import { BUCKET_CONFIG } from '@app/common/config/cdn';
import CustomError from '@app/common/utils/custom.error';
...
type ReadStream = ReturnType<FileUpload['createReadStream']>;
...
export class FileUploadService {
    ...
    protected getFileStream(file: FileUpload, bucket: BucketNames): ReadStream {
